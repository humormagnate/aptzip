...
// rank -> `rank`
// NewJdbcConnectionRepository -> JdbcConnectionRepository
// https://github.com/spring-projects/spring-social/issues/242
// https://github.com/mihajul/spring-social/blob/48d49d8065/spring-social-core/src/main/java/org/springframework/social/connect/jdbc/JdbcUsersConnectionRepository.java
@Slf4j
public class NewJdbcConnectionRepository implements ConnectionRepository {
	...
	public NewJdbcConnectionRepository(String userId, JdbcTemplate jdbcTemplate, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor, String tablePrefix) {
		this.userId = userId;
