...
public class NewJdbcUsersConnectionRepository implements UsersConnectionRepository {
	...
	public List<String> findUserIdsWithConnection(Connection<?> connection) {
		log.info("============================= findUserIdsWithConnection =============================");
  ...
  // return NewJdbcConnectionRepository
	public ConnectionRepository createConnectionRepository(String userId) {
		if (userId == null) {
			throw new IllegalArgumentException("userId cannot be null");
		}
		return new NewJdbcConnectionRepository(userId, jdbcTemplate, connectionFactoryLocator, textEncryptor, tablePrefix);
	}
